...
#define SHKMyAppName			@"ImgurViewer"
#define SHKMyAppURL				@"http://itunes.apple.com/app/imgurviewer/id499792983"
...
#define SHKFacebookAppID      @"331401110228265"
#define SHKFacebookLocalAppID      @"5ad9fdbbb00c3f649fd5ec032c4c8375"
 ...
 */
#define SHKTwitterConsumerKey		@"8I3DMOCxLwMDULE4j7lI6Q"
#define SHKTwitterSecret			@"jWb6HOuT5bWgMRswF38DJA0eKLCaneupMLX3tLF9fXg"
#define SHKTwitterCallbackUrl		@"http://www.imgurviewer.co.cc/" // You need to set this if using OAuth, see note above (xAuth users can skip it)
...
#define SHKBitLyLogin				@"demonicauror"
#define SHKBitLyKey					@"R_63c3410f0376b64c1a01eb9e4e466ae6"
