...
@synthesize imageView = _imageView,scrollView = _scrollView, imageHash = _imageHash;
...
- (void)viewDidLoad {
    ...
    self.scrollView.frame = CGRectMake(self.scrollView.frame.origin.x, self.scrollView.frame.origin.y, 320, self.scrollView.frame.size.height);
...
//    zoomRect.size.width  = self.scrollView.frame.size.width  / scale;
    zoomRect.size.width = self.scrollView.frame.size.width;
